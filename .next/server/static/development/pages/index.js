...
function Index({
  ...
  return __jsx("div", {
    ...
    __self: this
  }, markdownFiles.map((element, i) => __jsx(react_markdown__WEBPACK_IMPORTED_MODULE_1___default.a, {
    key: i,
    source: element,
    __source: {
      fileName: _jsxFileName,
...
Index.getInitialProps = function () {
  ...
  const markdownFiles = importAll(__webpack_require__("./posts sync recursive \\.md$")).reverse();
  return {
    markdownFiles
  };
};
...
module.exports = __webpack_require__(/*! /Users/mac/Desktop/dev/wesbragagt/pages/index.js */"./pages/index.js");
